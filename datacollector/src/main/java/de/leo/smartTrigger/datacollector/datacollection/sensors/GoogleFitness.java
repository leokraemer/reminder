                        ...
                        new GoogleApiClient.ConnectionCallbacks() {
                            ...
                            public void onConnectionSuspended(int i) {
                                ...
                                if (i == GoogleApiClient.ConnectionCallbacks.CAUSE_NETWORK_LOST) {
                                    ...
                                    Log.i(TAG, "Connection lost. google fit lost. Reason: Service Disconnected");
                                }
                            }
                        }
                )
            /*    .enableAutoManage((AppCompatActivity)context, 2, new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
