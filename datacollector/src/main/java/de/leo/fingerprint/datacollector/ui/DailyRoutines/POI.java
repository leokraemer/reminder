...
public class POI {
    ...
    public POI(JSONObject jsonObject) throws JSONException {
        ...
        square.add(new LatLng(POIs_min_latitude, POIs_min_longitude));
        square.add(new LatLng(POIs_min_latitude, POIs_max_longitude));
        square.add(new LatLng(POIs_max_latitude, POIs_max_longitude));
        square.add(new LatLng(POIs_max_latitude, POIs_min_longitude));
        area = SphericalUtil.computeArea(square);
