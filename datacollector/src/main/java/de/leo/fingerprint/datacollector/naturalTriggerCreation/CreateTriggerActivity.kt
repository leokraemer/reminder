...
import de.leo.fingerprint.datacollector.naturalTriggerCreation.location.LocationSelection
import de.leo.fingerprint.datacollector.naturalTriggerCreation.location.GeofenceDialogListener
import de.leo.fingerprint.datacollector.naturalTriggerCreation.location.WifiDialogListener
import de.leo.fingerprint.datacollector.uiElements.LockableViewPager
 ...
 */
class CreateTriggerActivity : GeofenceDialogListener, WifiDialogListener, NaturalTrigger
.ModelChangedListener,
    ...
    override fun modelChangedCallback() {
        with(model) {
            ...
            //activity switch sit / movement
            if (model.checkActivity(JITAI_ACTIVITY.SIT)) {
                if (NUM_PAGES != 6) {
                    NUM_PAGES = 6
    ...
    private val reminderSelection = ReminderSelection()
