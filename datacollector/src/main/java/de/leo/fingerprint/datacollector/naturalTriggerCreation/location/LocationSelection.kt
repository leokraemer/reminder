...
import de.leo.fingerprint.datacollector.naturalTriggerCreation.NaturalTriggerFragment
...
class LocationSelection : NaturalTriggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        createText.setOnClickListener { clickMap() }
...
interface WifiDialogListener {
    fun onWifiSelected(geofence: ScanResult)
