package com.example.yunlong.datacollector.ComboSeekBar;
...
public class ComboSeekBar extends SeekBar {
    public final String t = "ComboSeekBar";
	...
	public ComboSeekBar(Context context) {
		super(context);
        TypedArray a = context.obtainStyledAttributes(R.styleable.ComboSeekBar);

        mColor = a.getColor(R.styleable.ComboSeekBar_myColor, Color.WHITE);
        mTextSize = a.getDimensionPixelSize(R.styleable.ComboSeekBar_textSize, 12);
        mIsMultiline = a.getBoolean(R.styleable.ComboSeekBar_multiline, true);
        ...
        mPadding = 20;
        setProgressDrawable(new CustomDrawable(this.getProgressDrawable(),this, mThumb.getRadius(),mDots,mColor, mTextSize, mIsMultiline,mPadding));
	...
	public void setColor(int color) {
		...
		setProgressDrawable(new CustomDrawable((CustomDrawable) this.getProgressDrawable(), this, mThumb.getRadius(), mDots, mColor, mTextSize, mIsMultiline, mPadding));
	}
    public void setTextSize(int textSize) {
        mTextSize = textSize;
        setProgressDrawable(new CustomDrawable((CustomDrawable) this.getProgressDrawable(), this, mThumb.getRadius(), mDots, mColor, textSize, mIsMultiline,mPadding));
	 ...
	 * 
	 * @see android.widget.ListView#setOnItemClickListener(OnItemClickListener)
	 */
